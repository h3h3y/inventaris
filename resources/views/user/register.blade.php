...
<body>
    <div id="login">
        <h3 class="text-center text-white pt-5">Registrasi form</h3>
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="{{ url('proses-registrasi') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                <br>
                                <input type="submit" name="submit" class="btn btn-info btn-md form-control" value="Registrasi">
                            </div>
                        </form>
                    </div>
                </div>
